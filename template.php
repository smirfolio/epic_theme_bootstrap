 ...
 */
function epic_theme_bootstrap_theme($existing, $type, $theme, $path) {
  $theme_array = array();
 ...
 */
function epic_bootstrap_bootstrap_based_theme() {
  return array('epic_bootstrap' => TRUE);
}

/**
 * Implements hook_preprocess_html().
 */
function epic_theme_bootstrap_preprocess_html(&$variables) {
  $cdn_setting = theme_get_setting('bootstrap_cdn_provider', 'epic_theme_bootstrap');
 ...
 *   The first letter.
 */
function epic_theme_bootstrap_letters_badge_title() {
 ...
 * @see page.tpl.php
 */
function epic_theme_bootstrap_preprocess_page(&$variables) {
  // Add badge letter.
  $first_letter_title = epic_theme_bootstrap_letters_badge_title();
  ...
  $cdn_setting = theme_get_setting('bootstrap_cdn_provider', 'epic_theme_bootstrap');
  if (empty($cdn_setting)) {
    drupal_add_js(drupal_get_path('theme', 'epic_theme_bootstrap') . '/bootstrap/js/bootstrap.js');
  }
  ...
  $variables['profile_path'] = epic_theme_bootstrap_get_user_profile_page();
}
 ...
 *   The Profile path.
 */
function epic_theme_bootstrap_get_user_profile_page() {
  global $user;
  if (!empty($user->name)) {
 ...
 */
function epic_theme_bootstrap_menu_local_action($variables) {
